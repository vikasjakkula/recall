      ...
      <main>
        ...
        <section className="container mx-auto px-8 max-w-7xl py-12 md:py-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/auth/register" className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition">Start Preparing Now</Link>
              <button className="border border-blue-600 text-blue-600 px-6 py-3 rounded-md hover:bg-blue-50 transition">View Test Series</button>
            </div>
            ...
            {activeTab === 'previous' ? (
              <>
                ...
                <div className="text-center">
                  <button className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition">View All Test Series</button>
                </div>
              </>
            ) : (
        ...
        <section className="bg-blue-600/95 py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-8 max-w-7xl text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-white text-blue-600 px-8 py-4 rounded-lg hover:bg-blue-50 transition transform hover:scale-105 shadow-lg font-semibold">
            ...
            <div className="p-6">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center text-gray-600">
                  ...
                  Access to all 70 years of previous papers
                </li>
                <li className="flex items-center text-gray-600">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
             ...
             <button className="w-full bg-blue-600 text-white py-3 rounded-md hover:bg-blue-700 transition mb-3">Purchase Now</button>
       ...
       <section className="container mx-auto px-8 max-w-7xl py-8 mb-8">
         <div className="max-w-3xl mx-auto border border-gray-200 rounded-lg p-6">
           ...
           <button className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition">Become an Affiliate</button>
         </div>
       </section>
     </main>
