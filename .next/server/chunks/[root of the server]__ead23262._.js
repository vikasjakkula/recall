...
async function GET() {
    try {
        ...
        const userId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])();
        ...
        const { data: user, error } = await supabase.from('users').select('id, name, phone, email').eq('id', userId).single();
        if (error || !user) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ead23262._.js.map