...
async function POST(request) {
    try {
        ...
        const { data: existingUser } = await supabase.from('users').select('id').or(`phone.eq.${phone}`).single();
        if (existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Send OTP
        const { verificationId, error: otpError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOTP"])(phone);
        if (otpError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: otpError
            }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0203ea5c._.js.map